            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="main-heading">
                        <span class="span1">EVERY</span>
                        <span class="span2">SMILE</span>
                        <span class="span3">MATTERS</span>


                    </h1>

                    <div class="info-card">
                        <p>Our skilled dentists use advanced technology to offer complete care in a comfortable and friendly environment.</p>
                    </div>
                    ...
                    <a href="#appointment" class="btn-book index_button_section">BOOK APPOINTMENT</a>
                </div>
            </div>
        </div>
...
<!-- <div class="services-nav">
        <div class="container">
            <ul>
                ...
                <li><a href="#denta-care">Denta Care</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-12">
                <h2 class="about_about">About Us </h2>
                <h1 class="about_dental_section">Dental Care</h1>
            </div>
...
<!-- <div class="services-bottom-nav">
    <div class="container">
        <ul>
            ...
            <li><a href="#dentures-bottom">Dentures</a></li>
        </ul>
    </div>
</div> -->
<section>
            ...
            <div class="col-12 col-md-6">
                <div class="accordion">
                    ...
                    <div class="faq_section">
                        ...
                        <div class="accordion-header" onclick="toggleAccordion(this)">
                            <h2 class="faq_heading_section">Are veneers permanent?
                        ...
                        <div class="accordion-content">
                            <p>
                                They are long lasting but not permanent. They usually last for 10 years & with good care for 15 years or more. Should not bite anything hard with the teeth having veneers.
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="accordion">
                    ...
                    <div class="faq_section">
                        ...
                        <div class="accordion-content">
                            <p>
                                Modern RCT is done under anesthesia and is mostly painless.</p>
                        </div>
                    </div>
                    <!-- Accordion 2 -->
                    ...
                    <div class="faq_section">
                        <div class="accordion-header" onclick="toggleAccordion(this)">
                            <h2 class="faq_heading_section">Will the extraction hurt?
                        ...
                        <div class="accordion-content">
                            <p>
                                No, it’s done under anesthesia. You may feel mild pressure, not pain.</p>
                        </div>
                    </div>
